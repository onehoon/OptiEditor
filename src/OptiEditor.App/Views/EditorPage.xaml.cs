...
public sealed partial class EditorPage : Page
{
    ...
    private void RenderSettings()
    {
        ...
        foreach (var group in matchingSettings.GroupBy(x => x.GroupName))
        {
            ...
            {
                var grid = new Grid { ColumnSpacing = 12 }; grid.ColumnDefinitions.Add(new ColumnDefinition { Width = new GridLength(1, GridUnitType.Star) }); grid.ColumnDefinitions.Add(new ColumnDefinition { Width = GridLength.Auto }); grid.ColumnDefinitions.Add(new ColumnDefinition { Width = GridLength.Auto });
