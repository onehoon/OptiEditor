...
public sealed class BuiltInPresetProvider : IBuiltInPresetProvider
{
    ...
    [
        ...
        new(Guid.Parse("6b9d49aa-5ec3-41a0-bd4f-8e81cdd5f1ba"), "DLSSG to XeFG", "DLSSG Streamlinre to XeFG", OptiSchemaFamily.V10, PresetSource.BuiltIn, [new("FrameGen.Enabled", "true"), new("FrameGen.FGInput", "dlssg"), new("FrameGen.FGOutput", "xefg")], BuiltInDate, BuiltInDate),
